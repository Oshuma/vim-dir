...
exec "Snippet head <head><CR><meta http-equiv=\"Content-type\" content=\"text/html; charset=utf-8\" /><CR><title>".st.et."</title><CR></head><CR>"
...
exec "Snippet body <body><CR>".st.et."<CR></body><CR>"
